...
All final rows were run with `--verify` and `-r 3`. The final CSVs are in
`results/*_0.100000i_0m_mix_results_table.csv` and
`results/*_0.900000i_0m_mix_results_table.csv`. Plots for throughput and index
size are in this directory.
